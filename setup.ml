...
(* OASIS_START *)
(* DO NOT EDIT (digest: ee607569968b428a93b16ada3b45375d) *)
(*
...
let setup_t =
  {
     ...
     doc = [("api-primes", OCamlbuildDocPlugin.doc_build "src/")];
     ...
     clean_doc = [("api-primes", OCamlbuildDocPlugin.doc_clean "src/")];
     distclean = [];
     distclean_test =
       [
          ("main",
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["PrimesNum"];
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "primes";
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for Primes";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "primes";
                           InternalLibrary "primes-num"
                        ];
                      bs_build_tools =
